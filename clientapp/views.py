...
def get_tours_info(request, tour_url):
    ...
    return render_to_response('tours_info.html', {"dates":dates, "bookings":bookings, "tour":tour, "tour_in_timetable": TourInTimetable.objects.filter(tourID = tour.id), "firstTour":firstTour})
